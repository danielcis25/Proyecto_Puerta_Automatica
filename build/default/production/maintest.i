...
void main()
{
    ...
    while(1){
        ...
        if(PORTAbits.RA2 == 0 && PORTAbits.RA1 == 1 && v_detInterior == 1){
            v_detExterior = 0;
        }
     if(PORTAbits.RA3 == 1 && v_detExterior == 0){
            LATC0 = 1;
        ...
        if(PORTAbits.RA2 == 1 && PORTAbits.RA1 == 0 && v_detExterior == 0){


            v_estadoINF1 = 1;
        }
        if(PORTAbits.RA1 == 1 && v_estadoINF1 == 1){
            v_detExterior = 1;
            v_cuenta++;
            v_estadoINF1=0;
        ...
        if(PORTAbits.RA2 == 1 && PORTAbits.RA1 == 0 && v_detExterior == 1){
            v_detInterior = 0;
        }
# 120 "maintest.c"
        if(PORTAbits.RA2 == 0 && PORTAbits.RA1 == 1 && v_detInterior == 0){


            v_estadoINF2 = 1;
        }
        if(PORTAbits.RA2 == 1 && v_estadoINF2 == 1 && v_detInterior == 0){
            v_detInterior = 1;
            v_cuenta--;
            v_estadoINF2 = 0;
        }
